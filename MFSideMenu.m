...
- (UIBarButtonItem *)menuBarButtonItem {
    ...
    [menuButton setBackgroundImage:menuButtonHighlighted forState:UIControlStateHighlighted];
    [menuButton addTarget:self action:@selector(toggleSideMenuPressed:)
    ...
    UIBarButtonItem *barButtonItem = [[UIBarButtonItem alloc]
            initWithImage:[UIImage imageNamed:@"menu-stripes.png"] style:UIBarButtonItemStylePlain
            target:self
            action:@selector(toggleSideMenuPressed:)];
    // barButtonItem.tintColor = [UIColor colorWithRed:234.0/255.0 green:208.0/255.0 blue:23.0/255.0 alpha:1.0];
    UIImage *image = [UIImage imageNamed: @"menu-button-background.png"];
    [barButtonItem setBackgroundImage:image forState:UIControlStateNormal barMetrics:UIBarMetricsDefault];
    [barButtonItem setBackgroundImage:image forState:UIControlStateHighlighted barMetrics:UIBarMetricsDefault];
     */
